...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while not curr_place.is_hive:
            if random_bee(curr_place.bees) and self.lower_bound <= count <= self.upper_bound:
...
class HungryAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        some_bee = random_bee(self.place.bees)
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 8a
        return False if other.is_container or self.ant_contained else True
        # END Problem 8a
...
# END Problem 12
    ...
    def action(self, gamestate):
        ...
        while curr_place.exit:
            some_ant = curr_place.ant
            if some_ant:
                if isinstance(some_ant, ContainerAnt) and some_ant.ant_contained:
                   some_ant.ant_contained.double()
                some_ant.double()
