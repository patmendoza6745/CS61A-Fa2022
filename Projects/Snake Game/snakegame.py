...
score_numb_font = pygame.font.Font(None,35)
game_over_font = pygame.font.Font(None,38)
play_again_font = score_numb_font
score_msg = score_font.render("Score : ",1,pygame.Color("black"))
score_msg_size = score_font.size("Score")
background_color = pygame.Color(255,255,255)    # we will fill background color as black
